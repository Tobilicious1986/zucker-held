...
Für Frontend-Arbeit gelten zusätzlich die Root-Regeln aus `../CLAUDE.md`, `../AGENTS.md` und `../docs/agents/PROJECT_RULES.md`.
...
Wenn mehrere Frontend-Arbeitspakete parallel laufen, sind Dailies, Cross-Reviews und die laufende Protokollierung in `../docs/sprints/SPRINT{N}.md` verpflichtend.
...
`../docs/sprints/SPRINT{N}.md` ist das gemeinsame Lagebild für parallele Frontend-Stränge, letzte Zwischenstände und offene Blocker.
...
- UAT-Szenarien in `../docs/uat/UAT_SPRINT_{N}.md` dürfen nur ✅ erhalten, wenn das Szenario manuell im Browser oder per automatisiertem Test wirklich durchgespielt wurde.
...
- Nicht testbare Teile müssen mit Begründung und Nachholplan in `../docs/sprints/SPRINT{N}.md` dokumentiert werden.
